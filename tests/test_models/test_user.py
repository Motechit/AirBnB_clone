...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_for_instantiation(self):
        """It checks the instantiation of the User class"""
        user = User()
    ...
    def test_is_subclass(self):
        """It checks that User is a subclass of BaseModel"""
        user = User()
    ...
    def test_email_attr(self):
        """It checks that the email attribute exists and is an empty string"""
        user = User()
        self.assertTrue(hasattr(user, "email"))
        self.assertEqual(user.email, "")

    def test_password_attr(self):
        """It checks that the pw attribute exists and is an empty string"""
        user = User()
    ...
    def test_str(self):
        """It ensures str mtd has the right output"""
        user = User()
    ...
    def test_to_dict_creates_dict(self):
        """It ensures to_dict mtd creates a dict. appropriately"""
        u = User()
        new_d = u.to_dict()
    ...
    def test_to_dict_values(self):
        """It ensures the returned values from to_dict are correct"""
